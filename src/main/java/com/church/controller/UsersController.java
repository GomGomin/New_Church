...
public class UsersController {
    ...
    public String SubmitUpdateUser(@ModelAttribute("UpdateUser") Users user, Principal principal) {
    ...
    public String DetailUser(@RequestParam(value = "username", required = false) String username,
