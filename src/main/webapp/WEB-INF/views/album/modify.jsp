...
<body>
  ...
  <div class="w3-container w3-padding-64" id="contact">
	...
	<!-- 업로드 결과 출력 -->
	<div class="uploadResult" style="margin-top: 50px; width: 500px;">
		<ul>
		...
		<li data-folder='${attachList.upFolder}' data-uuid='${attachList.uuid}' data-filename='${attachList.fileName}' data-image='${attachList.image}'>
				<img  class="original" src="/resources/images/${attachList.upFolder}/s_${attachList.uuid}_${attachList.fileName}"><br>
				${attachList.fileName}
	...
	<button type="button" style="margin-top: 30px;" id="subBtn" class="w3-button w3-black w3-margin-bottom"><i class="fa fa-paper-plane w3-margin-right"></i>수정</button>
</div>
  </form>
  </div>
