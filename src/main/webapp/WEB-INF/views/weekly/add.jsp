...
<body>
  ...
  <div class="w3-container w3-padding-64" id="contact">
    <h1>주보 등록</h1><br>
    		...
    		<form action="/weekly/add?${_csrf.parameterName}=${_csrf.token}" role='form' class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <hr class="w3-opacity">
  		<div>
			...
			<div class="w3-third" style="width: 30%; margin-right: 900px; margin-bottom: 10px;">
				<input class="form-control" id="wtitle" name="wtitle" required="required"
					  type="text" />
			</div>
		</div>
