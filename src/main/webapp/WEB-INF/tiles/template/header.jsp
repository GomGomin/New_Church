    ...
    <div class="w3-bar w3-white w3-card" id="myNavbar">
        ...
        <div class="w3-left w3-hide-small w3-hide-medium">
            ...
            <sec:authorize access="hasRole('ROLE_USER')">
                <div class="dropdown w3-bar-item w3-button">
                    ...
                    <c:if test="${hasPickup}">
                        <a href="/pickup/detail?pbwriter=${username}">
                            <button>내 픽업 보기</button>
                        </a>
                    </c:if>
                </div>
            </sec:authorize>
        ...
        <nav class="w3-sidebar w3-bar-block w3-white w3-card w3-animate-left" style="display:none" id="mySidebar">
            ...
            <sec:authorize access="hasRole('ROLE_USER')">
                ...
                <c:if test="${hasPickup}">
                    <a href="/pickup/detail?pbwriter=${username}" onclick="w3_close()" class="w3-bar-item w3-button">내
                        픽업 보기</a>
                </c:if>
            </sec:authorize>
...
<img data-bs-toggle="offcanvas" aria-expanded="false" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"
     id="STATICMENU" style="width: 180px; height: 150px;" src="/resources/img/GPT.png">


<div class="offcanvas offcanvas-end text-center" tabindex="-1" data-bs-scroll="true" data-bs-backdrop="false"
     id="offcanvasRight" aria-labelledby="offcanvasRightLabel" style="z-index: 10000;">
